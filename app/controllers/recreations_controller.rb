...
#       targets: ['ほぼ自立'],
#       description: 'おかげ横丁、おはらい町から伊勢神宮まで生中継双方向で撮影をしながら、様々なお土産店にも入店。３～５種類のお土産付き！ 実際に施設に届くお土産を試食しながらの参加となるので旅行している気分に！ご要望があれば、買い物もツアー後に可能です。ツアー最後には、伊勢神宮内宮入り口近くにある足に良いとされる「足神さん」 と呼ばれる宇治神社でツアーフィニッシュ。',
