...
RSpec.describe 'OrdersForceCompleteFromInProgress', type: :request do
  ...
  describe 'GET #index' do
    it 'return http success' do
      get admin_orders_force_complete_from_in_progresses_path
  ...
  describe 'GET #show' do
    it 'return http success' do
      get admin_orders_force_complete_from_in_progress_path(order.id)
      expect(response).to have_http_status(:ok)
    end
  end
  ...
  describe 'GET #edit' do
    it 'return http success' do
      get edit_admin_orders_force_complete_from_in_progress_path(order.id)
      expect(response).to have_http_status(:ok)
    end
  end
