...
export const FavoriteIcon: React.FC<Props & FavoriteIconProps> = ({ onClick, isFavorited }) => {
  const fillColor = isFavorited ? "rgb(255, 48, 64)" : "none";
  const strokeColor = isFavorited ? "rgb(255, 48, 64)" : "#6C757D";

  return (
    <div onClick={onClick} style={{ cursor: 'pointer' }}>
      <svg width='20' height='20' version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280.000000 1244.000000">
