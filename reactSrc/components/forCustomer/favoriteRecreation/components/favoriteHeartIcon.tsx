...
import { FAVORITE_COLOR, DEFAULT_COLOR, DEFAULT_STROKE_COLOR } from './iconColorConstants';
...
export const FavoriteHeartIcon: React.FC<FavoriteHeartIconProps> = ({ isFavorite, onClick, width = '20', height = '20' }) => {
  const fillColor = isFavorite ? FAVORITE_COLOR : DEFAULT_COLOR;
  const strokeColor = isFavorite ? FAVORITE_COLOR : DEFAULT_STROKE_COLOR;
