  ...
  return (
    <div>
      <div className='d-flex'>
        <p className='ms-1 px-1 small text-secondary font-weight-bold border border-2 border-black rounded-circle'>✔︎</p>
        <p className='ms-1 px-1 small text-black font-weight-bold border border-2 border-dark rounded-pill'>ステップ2</p>
      ...
      <ol>
        <li>無料大容量 ファイル転送サービス GigaFile(ギガファイル)便<span><a href='https://gigafile.nu/' target='_blank' rel="noreferrer" className='text-primary'>FileGiga</a></span>にアクセス</li>
