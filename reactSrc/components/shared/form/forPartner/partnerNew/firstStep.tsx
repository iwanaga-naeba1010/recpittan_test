    ...
    <>
      ...
      <div className='p-3'>
        ...
        <div>
          ...
          <p className='m-0 text-black'>あなたは審査を通過しましたのでサービスへ新規登録をお願いします。</p>
        </div>
        ...
        <div className='mt-3'>
          ...
          <div>
            ...
            <label htmlFor="terms" className='terms'><span><a href="#" className="ms-1 text-primary fw-bold">利用規約</a></span>に同意します</label>
          </div>

          <div>
            <input type="checkbox" id="privacy" className="mt-3" />
            <label htmlFor="privacy" className='privacy'><span><a href="#" className="ms-1 text-primary fw-bold">プライバシーポリシー</a></span>に同意します</label>
          </div>
        </div>
      </div>
    </>
